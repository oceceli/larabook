    ...
    <div class="bg-white h-12 px-4 flex items-center border-b border-gray-400 shadow-sm">
        <div class="w-1/3">
            <div class="flex">
                ...
                <div class="ml-2 flex relative" id="search-box">
                    <div class="absolute text-gray-700">
                        <svg viewBox="0 0 24 24" class="fill-current w-5 h-5 mt-2 ml-2"><path fill-rule="evenodd" d="M20.2 18.1l-1.4 1.3-5.5-5.2 1.4-1.3 5.5 5.2zM7.5 12c-2.7 0-4.9-2.1-4.9-4.6s2.2-4.6 4.9-4.6 4.9 2.1 4.9 4.6S10.2 12 7.5 12zM7.5.8C3.7.8.7 3.7.7 7.3s3.1 6.5 6.8 6.5c3.8 0 6.8-2.9 6.8-6.5S11.3.8 7.5.8z" clip-rule="evenodd"/></svg>
                    </div>
                    <input type="text" name="search" 
                        class="w-56 bg-gray-200 h-8 rounded-full focus:outline-none focus:shadow-outline text-sm pl-8"
                        placeholder="Search Facebook">
                </div>
            </div>
        </div>
        <div class="w-1/3 flex justify-center items-center h-full">
            <router-link to="/" class="px-6 h-full border-white flex items-center focus:border-blue-600 border-b-2 focus:text-blue-600">
            ...
            <router-link :to="'/users/' + authUser.data.user_id" class="px-6 h-full border-white flex items-center focus:border-blue-600 border-b-2">
                <img src="https://widgetwhats.com/app/uploads/2019/11/free-profile-photo-whatsapp-4.png" alt="user-image" class="w-8 h-8 object-cover rounded-full">
            </router-link>
            <router-link to="/" class="px-6 h-full border-white flex items-center focus:border-blue-600 border-b-2 focus:text-blue-600">
